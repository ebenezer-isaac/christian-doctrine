...
needs no external wiring to be fully functional: ``python -m cd_mcp.server``
...
from cd_mcp.live.cultural import build_cultural_clients, retrieve_cultural_chunks
from cd_mcp.live.lexical import lexical_driver
